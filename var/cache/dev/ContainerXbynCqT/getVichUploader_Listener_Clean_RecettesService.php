 ...
 */
class getVichUploader_Listener_Clean_RecettesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.recettes' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.recettes'])) {
            return $container->privates['vich_uploader.listener.clean.recettes'];
        }

        return $container->privates['vich_uploader.listener.clean.recettes'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('recettes', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
